...
exports.run = async (client, message, args) => {
  ...
  message.guild.members.cache.get(kullanıcı.id).addRole(erkekROL);
  message.guild.members.cache.get(kullanıcı.id).addRole(kayıtlıROL);
  message.guild.members.cache.get(kullanıcı.id).removeRole(kayıtsızROL);
